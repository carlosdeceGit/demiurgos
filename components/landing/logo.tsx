    ...
    >
      <defs>
        <linearGradient id="dmgGrad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#4ef59a" />
          <stop offset="0.55" stopColor="#22d67a" />
          <stop offset="1" stopColor="#18a85f" />
        </linearGradient>
        <radialGradient id="dmgGlow" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#22d67a" stopOpacity="0.55" />
          <stop offset="1" stopColor="#22d67a" stopOpacity="0" />
        </radialGradient>
      </defs>
      <rect x="1.5" y="1.5" width="37" height="37" rx="12" fill="#0A0D0E" stroke="#22d67a" strokeOpacity="0.35" strokeWidth="1.2" />
